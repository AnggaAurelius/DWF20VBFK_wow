    ...
    return (
        <div className="  row pt-4">
            ...
            <div className="col-md-7" >
                ...
                <h1 className="mt-5 font-weight-bold" >Tes on the road</h1>
                <p>Penulis</p>
                <br/>
                <div className="mt-5" >
                    <h3 className="font-weight-bold">Publication date</h3>
                    <p>April 2020</p>
                    <h3 className="mt-4 font-weight-bold">Pages</h3>
                    <p>436</p>
                    <h3 className="mt-4 text-danger font-weight-bold">ISBN</h3>
                    <p>97684534326</p>
                </div>
                <h3 className="detxt font-weight-bold">About this book</h3>
